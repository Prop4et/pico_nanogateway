...
class NanoGateway:     
    ...
    def start(self, lora_obj):
        ...
        self.udp_sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM) #SOCK_DGRAM automatically sets to udp 
        ...
        self.pull_alarm = Timer(mode=Timer.PERIODIC, period=60000, callback=lambda u: self._pull_data())
        self.udp_stop = False
    ...
    def _udp_thread(self):
        ...
        while not self.udp_stop:
            try:
                data, src = self.udp_sock.recvfrom(1024)
                ...
                if _type == PUSH_ACK:
                    ...
                    if "tmst" in tx_pk['txpk']:
                        ...
                        self.send_down_link_c(ubinascii.a2b_base64(tx_pk["txpk"]["data"]))
